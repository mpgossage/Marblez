...
public class OTSpriteSheet : OTContainer
{
    ...
    override protected Frame[] GetFrames()
    {
        ...
        for (int f = 0; f < frames.Length; f++)
        {
            ...
            float TOL = 0.001f;
            frame.uv[0] = new Vector2(sx + TOL, sy + scy - TOL);
            frame.uv[1] = new Vector2(sx + scx - TOL, sy + scy - TOL);
            frame.uv[2] = new Vector2(sx + scx - TOL, sy + TOL);
            frame.uv[3] = new Vector2(sx + TOL, sy + TOL);
